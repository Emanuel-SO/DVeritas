    ...
    <div>
      ...
      <Card sx={{ maxWidth: {xs:"300px", sm:"80%", md:"60%" } ,margin:"auto", borderRadius: "15px" , my:"20px"}}>
        ...
        <CardActions disableSpacing>
          ...
          <Button aria-label="add to favorites" onClick={handleOpen}  startIcon={<ChatIcon/>} sx={{ marginLeft:"auto" }}>
              {props.comments}
          </Button>
                ...
                <form onSubmit={handleSubmit}> {/* se le asigna una funcion a ejecutar una vez se presione el submit */}
                  ...
                  <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minWidth: {xs:"300px", sm:"550px" }}}>{/* maxWidth recibe breack points por parte de MUI para hacer responsivo el tamaño de campo */}
                    ...
                    <TextField
                        ...
                        onChange={(e) => setComentario(e.target.value)}/* cada que cambie este input se ejecuta el hook para guardar el dato en una variable */
